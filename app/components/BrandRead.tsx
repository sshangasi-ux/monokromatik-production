                  ...
                  {isStructured ? (
                    <span>
                      <span className="block">
                        <span className="text-[10px] tracking-[0.2em] font-display font-bold text-mono-gray uppercase mr-2">
                          Where this lands
                        </span>
                        {point.insight}
                      </span>
                      <span className="block mt-2 text-mono-white">
                        <span className="text-[10px] tracking-[0.2em] font-display font-bold text-mono-amber uppercase mr-2">
                          What to do with it
                        </span>
                        {point.move}
                      </span>
