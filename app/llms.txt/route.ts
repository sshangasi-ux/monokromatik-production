...
- "Who Owns ___?" explainers — short, sourced ownership answers. Stayed African-owned: [MTN](${SITE}/article/who-owns-mtn), [Dangote](${SITE}/article/who-owns-dangote), [Shoprite](${SITE}/article/who-owns-shoprite), [Glo](${SITE}/article/who-owns-glo), [Access Bank](${SITE}/article/who-owns-access-bank), [Flutterwave](${SITE}/article/who-owns-flutterwave), [Nando's](${SITE}/article/who-owns-nandos), [Chivita](${SITE}/article/who-owns-chivita), [OCP Group](${SITE}/article/who-owns-ocp), [Africa's banks](${SITE}/article/who-owns-africas-banks). Sector reads: [banks](${SITE}/article/who-owns-africas-banks), [telecoms](${SITE}/article/who-owns-africas-telecoms), [Black beauty](${SITE}/article/who-owns-black-beauty). Owned abroad now: [Anglo American](${SITE}/article/who-owns-anglo-american), [SAB](${SITE}/article/who-owns-sab), [Vodacom](${SITE}/article/who-owns-vodacom), [Airtel Africa](${SITE}/article/who-owns-airtel-africa), [Maroc Telecom](${SITE}/article/who-owns-maroc-telecom), [Nestlé Nigeria](${SITE}/article/who-owns-nestle-nigeria), [Fenty Beauty (50/50 with LVMH)](${SITE}/article/who-owns-fenty-beauty), [Paystack](${SITE}/article/who-owns-paystack), [MultiChoice/DStv](${SITE}/article/who-owns-multichoice-dstv), [Safaricom](${SITE}/article/who-owns-safaricom), [Mavin Records](${SITE}/article/who-owns-mavin-records), [Indomie](${SITE}/article/who-owns-indomie), [OPay](${SITE}/article/who-owns-opay), [Amarula](${SITE}/article/who-owns-amarula), [Jumia](${SITE}/article/who-owns-jumia), [Nigerian Breweries](${SITE}/article/who-owns-nigerian-breweries), [Tecno](${SITE}/article/who-owns-tecno), [Tusker](${SITE}/article/who-owns-tusker), [Guinness Nigeria](${SITE}/article/who-owns-guinness-nigeria).
